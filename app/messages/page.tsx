...
const mockConversations: Conversation[] = [
  ...
  },
  {
    ...
    avatar: null,
    role: 'scout',
    lastMessage: 'I\'m from UCLA athletics. Loved your clips - would you be interested in a training session?',
    timestamp: '1d ago',
    unread: 1,
    messages: [
      {
      ...
      },
      {
        id: 'm7',
        senderId: 'me',
        content: 'Oh wow, thanks Coach! That\'s amazing to hear',
        timestamp: '2d ago',
        isRead: true,
      },
      {
      ...
      },
      {
        id: 'm9',
        senderId: '3',
        content: 'I\'m from UCLA athletics. Loved your clips - would you be interested in a training session?',
        timestamp: '1d ago',
        isRead: false,
      },
      {
        id: 'm10',
        senderId: '3',
        content: 'We\'re hosting a scouting session next month. Would love to see you there if you\'re free!',
        timestamp: '1d ago',
        isRead: false,
      },
    ],
