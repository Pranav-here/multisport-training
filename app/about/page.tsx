  ...
  return (
    <div className="container mx-auto px-4 py-6 pb-20 md:pb-6 space-y-8">
      ...
      <div className="text-center space-y-4">
        <h1 className="text-4xl font-bold">About AthletIQs</h1>
      ...
      <Card className="bg-gradient-to-r from-blue-50 to-green-50 border-blue-200">
        <CardContent className="p-8 text-center">
          ...
          <p className="text-muted-foreground mb-4">
            Ready to take your training to the next level? Join thousands of athletes already improving with AthletIQs.
          </p>
